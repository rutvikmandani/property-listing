"use client";
import UserType from "@/component/Dashboard/UserType";
import InputField from "@/component/UIFields/InputField";
import TextareaField from "@/component/UIFields/TextareaField";
          ...
          <div className="px-6 max-w-5xl">
            ...
            <div className="flex flex-col gap-6 mb-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <InputField type="text" placeholder="Name" onChange={() => null} />
                <InputField
                  type="text"
